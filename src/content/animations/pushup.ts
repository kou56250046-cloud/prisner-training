...
export const pushup09: Animation = {
  ...
  asymmetric: true,
  durationMs: 4500,
  camera: { minX: 5, maxX: 124, minY: -8, maxY: 46 },
  props: [
    { kind: 'ground' },
    { kind: 'ball', x: 80, y: 2.5, r: 2.5 },
    { kind: 'ball', x: 110, y: 6, r: 6 },
  ],
  guides: [{ kind: 'trail', joint: 'chest' }],
  caption:
  ...
  keyframes: [
    {
      ...
      pose: {
        ...
        armFar: { mode: 'ik', target: { x: 110, y: 12 }, bend: -1, ext: 0 },
        legNear: { mode: 'ik', target: ANKLE, bend: -1, ext: -60 },
      },
    },
    {
      ...
      pose: {
        ...
        head: 5,
        armNear: { mode: 'ik', target: HAND, bend: -1, ext: 0 },
        armFar: { mode: 'ik', target: { x: 112, y: 12 }, bend: -1, ext: 0 },
        legNear: { mode: 'ik', target: ANKLE, bend: -1, ext: -60 },
      },
    },
    {
